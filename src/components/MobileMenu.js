...
const MobileMenu = ({ isClicked, handleClick }) => {
  ...
  return (
    <div
      className={
        isClicked ? "mobile-menu-container" : "mobile-menu-container active"
      }
    >
        ...
        <div className="categories-container">
          <ul className="collapsed-list">
            <div className="features-container">
              <div className="features" onClick={() => setToggle(!toggle)}>
                <li>Features</li>
                <div className="">
                  {toggle ? (
                    <svg
            ...
            <div className="company-container">
              <div className="company" onClick={() => setClick(!click)}>
                <li>Company</li>
                <div>
                {click ? (
                    <svg
